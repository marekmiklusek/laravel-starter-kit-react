...
class Container_a8d71a1aae extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a8d71a1aae $container)
			{
	...
	public function createServiceContainer(): Container_a8d71a1aae
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\marek\AppData\Local\Temp\es9B049.tmp',
				...
				'platformcode' => 'AN',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\marek\AppData\Local\Temp\es9B049.tmp|0|*|*|C:\Users\marek\.config\herd\bin\php84\php.ini|3.4.7',
