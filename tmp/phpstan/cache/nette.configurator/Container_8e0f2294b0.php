...
class Container_8e0f2294b0 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8e0f2294b0 $container)
			{
	...
	public function createServiceContainer(): Container_8e0f2294b0
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => 'C:/Users/marek/Herd/wellmall',
				...
				'PHPRC' => 'C:\Users\marek\AppData\Local\Temp\u1g4830.tmp',
				...
				'PYTHONSTARTUP' => 'c:\Users\marek\AppData\Roaming\Code\User\workspaceStorage\44b36a4c8bdb2aac33d468b523d47b3a\ms-python.python\pythonrc.py',
				'PYTHON_BASIC_REPL' => '1',
				...
				'WINDIR' => 'C:\windows',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\marek\AppData\Local\Temp\u1g4830.tmp|0|*|*|C:\Users\marek\.config\herd\bin\php84\php.ini|3.4.7',
				'ZES_ENABLE_SYSMAN' => '1',
