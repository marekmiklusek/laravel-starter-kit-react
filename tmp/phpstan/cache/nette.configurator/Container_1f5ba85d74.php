...
class Container_1f5ba85d74 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1f5ba85d74 $container)
			{
	...
	public function createServiceContainer(): Container_1f5ba85d74
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\marek\AppData\Local\Temp\cch7C0C.tmp',
				...
				'WINDIR' => 'C:\windows',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\marek\AppData\Local\Temp\cch7C0C.tmp|0|*|*|C:\Users\marek\.config\herd\bin\php84\php.ini|3.4.7',
				'ZES_ENABLE_SYSMAN' => '1',
