...
class Container_1ce115e0d2 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1ce115e0d2 $container)
			{
	...
	public function createServiceContainer(): Container_1ce115e0d2
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\marek\AppData\Local\Temp\cj62F4.tmp',
				...
				'WINDIR' => 'C:\windows',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\marek\AppData\Local\Temp\cj62F4.tmp|0|*|*|C:\Users\marek\.config\herd\bin\php84\php.ini|3.4.7',
				'ZES_ENABLE_SYSMAN' => '1',
